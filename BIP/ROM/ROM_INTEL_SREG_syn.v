...
//altsyncram ADDRESS_ACLR_A="NONE" CLOCK_ENABLE_INPUT_A="NORMAL" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="MAX 10" ENABLE_RUNTIME_MOD="NO" INIT_FILE="ROM.hex" NUMWORDS_A=4096 OPERATION_MODE="ROM" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="UNREGISTERED" RAM_BLOCK_TYPE="M9K" WIDTH_A=16 WIDTH_BYTEENA_A=1 WIDTHAD_A=12 address_a clock0 clocken0 q_a
...
module  ROM_INTEL_SREG_altsyncram
	( 
	address_a,
	clock0,
	clocken0,
...
endmodule //ROM_INTEL_SREG_altsyncram
//VALID FILE
...
`endif
	...
	ROM_INTEL_SREG_altsyncram	ROM_INTEL_SREG_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.clocken0 (clken),
				.q_a (sub_wire0));
