...
//altsyncram ADDRESS_ACLR_A="CLEAR0" CLOCK_ENABLE_INPUT_A="NORMAL" CLOCK_ENABLE_OUTPUT_A="NORMAL" DEVICE_FAMILY="MAX 10" INIT_FILE="ROM.hex" NUMWORDS_A=4096 OPERATION_MODE="ROM" OUTDATA_ACLR_A="CLEAR0" OUTDATA_REG_A="CLOCK0" RAM_BLOCK_TYPE="M9K" WIDTH_A=16 WIDTH_BYTEENA_A=1 WIDTHAD_A=12 aclr0 address_a clock0 clocken0 q_a
...
`endif
	...
	defparam
		...
		ram_block1a_1.mem_init0 = 2048',
	...
	defparam
		...
		ram_block1a_5.mem_init0 = 2048',
...
endmodule //ROM_INTEL_altsyncram
//VALID FILE
...
`endif
	...
	ROM_INTEL_altsyncram	ROM_INTEL_altsyncram_component (
				.aclr0 (aclr),
				.address_a (address),
				.clock0 (clock),
				.clocken0 (clken),
