...
//altsyncram CLOCK_ENABLE_INPUT_A="NORMAL" CLOCK_ENABLE_OUTPUT_A="NORMAL" DEVICE_FAMILY="MAX 10" ENABLE_RUNTIME_MOD="NO" NUMWORDS_A=4096 OPERATION_MODE="SINGLE_PORT" OUTDATA_ACLR_A="CLEAR0" OUTDATA_REG_A="CLOCK0" POWER_UP_UNINITIALIZED="FALSE" read_during_write_mode_port_a="NEW_DATA_NO_NBE_READ" WIDTH_A=16 WIDTH_BYTEENA_A=1 WIDTHAD_A=12 aclr0 address_a clock0 clocken0 data_a q_a wren_a
...
module  MEMORIA_INTEL_altsyncram
	( 
	aclr0,
	address_a,
	clock0,
...
endmodule //MEMORIA_INTEL_altsyncram
//VALID FILE
...
`endif
	...
	MEMORIA_INTEL_altsyncram	MEMORIA_INTEL_altsyncram_component (
				.aclr0 (aclr),
				.address_a (address),
				.clock0 (clock),
				.clocken0 (clken),
